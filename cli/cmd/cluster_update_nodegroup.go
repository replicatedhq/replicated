...
replicated cluster update nodegroup CLUSTER_ID_OR_NAME --nodegroup-id NODEGROUP_ID --nodes 3

# Update the autoscaling limits for a nodegroup
replicated cluster update nodegroup CLUSTER_ID_OR_NAME --nodegroup-id NODEGROUP_ID --min-nodes 2 --max-nodes 5`,
