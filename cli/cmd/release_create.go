...
func (r *runners) InitReleaseCreate(parent *cobra.Command) error {
  ...
  To mark a release as required during upgrades:
	...
	cmd.Flags().StringVar(&r.args.createReleaseOutputDir, "output-dir", "", "Stage the release artifacts (packaged charts and manifests) to this directory. The directory is preserved after the command completes.")
